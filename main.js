...
window.addEventListener('resize', () => {
    ...
    if (window.innerWidth < 900) {
        readMeDes.innerHTML = "このサイトはJavaScriptを作りながら学ぶため<br>に作成したサイトです。<br>JavaScriptの機能を使うためのサイト構築をしており各機能はESModulesで分割しています。<br>また各sectionの最後にGitHub REST APIで<br>取得したsourcecodeを載せています。<br>サイト内にちりばめたJSの機能を体感して楽しんでください!"
    } else {
